...
| `sas-install-skills` | Install or update all skills from this repo to the local machine via `install-skills.ps1` — **repo-local only, must not be installed to the machine** |
