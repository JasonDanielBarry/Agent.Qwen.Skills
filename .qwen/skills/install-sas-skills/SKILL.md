...
This skill installs or updates all skills from this repository to the user's personal skills directory (`~/.qwen/skills/`) by running the `install-sas-skills.ps1` PowerShell script. It ensures skills on the machine are in sync with the latest versions in this repo.
